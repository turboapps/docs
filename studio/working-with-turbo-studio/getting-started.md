...
![Turbo Studio](https://hub.turbo.net/images/docs/main.png)
...
- **Import Configuration** button allows an application package to be imported from a file (.ini, .msi, .axt, .appv), the turbo.net hub, or the local image repository. For more information, see [Import Configuration](https://hub.turbo.net/docs/studio/working-with-turbo-studio/import-configuration).
