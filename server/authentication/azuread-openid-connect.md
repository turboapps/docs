...
For prerequisites and additional information about the OpenID Connect authentication protocol, please refer to the [OpenID Connect Prerequisites](https://hub.turbo.net/docs/server/authentication/openid-connect#prerequisites) section.
...
- **Supported account types**: The account types that are allowed to login. To allow logins from multiple specific tenants, see [Azure AD Multi-Tenancy](https://hub.turbo.net/docs/server/authentication/azuread-openid-connect#azure-ad-multi-tenancy).

![Azure AD Setup Register](https://hub.turbo.net/images/docs/register.png)
...
![Azure AD Setup Redirect URL](https://hub.turbo.net/images/docs/authentication-redirect-urls.png)
...
![Azure AD API Permissions](https://hub.turbo.net/images/docs/permissions-directory.png)
...
![OpenID Connect Authentication Method](https://hub.turbo.net/images/docs/authentication-method-openid-connect.png)
...
To only allow specific Azure AD tenants, see [Administering Authentication Method](https://hub.turbo.net/docs/server/administration/users#authentication-method).

![oidc-multi-tenant](https://hub.turbo.net/images/docs/oidc.png)
