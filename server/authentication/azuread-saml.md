...
![AzureAD SSO + SAML 2.0 add enterprise application](https://hub.turbo.net/images/docs/add-saml2-app.png)

Once the application has been created, click on the **Single sign-on** tab and select the **SAML** authentication method.

![AzureAD SSO + SAML 2.0 select authentication method](https://hub.turbo.net/images/docs/saml2-sso.png)
...
![AzureAD SSO + SAML 2.0 configration](https://hub.turbo.net/images/docs/saml2-config.png)
...
![Azure AD SSO + SAML 2.0 server settings 1](https://hub.turbo.net/images/docs/saml2-server-settings-1.png)
...
- **Request Signing Private Key**: The private key of the SP signing certificate. See [Configure the Service Provider Signing Certificate](https://hub.turbo.net/docs/server/authentication/azuread-saml#configure-turbo-server-configure-the-service-provider-signing-certificate).
- **Request Signature Algorithm**: The signature algorithm of the SP signing certificate. See [Configure the Service Provider Signing Certificate](https://hub.turbo.net/docs/server/authentication/azuread-saml#configure-turbo-server-configure-the-service-provider-signing-certificate).
...
![Azure AD SSO + SAML 2.0 server settings 2](https://hub.turbo.net/images/docs/saml2-server-settings-2.png)
...
![AzureAD SSO + SAML 2.0 certificates](https://hub.turbo.net/images/docs/saml2-certs.png)
...
5. Click on the new **Certificates** Snap In, then click **All Tasks** > **Import...** ![SAML Certnstall](https://hub.turbo.net/images/docs/SAML-cert-install.PNG)
6. Select **Local Machine** and click **Next** ![SAML Cert Install 2](https://hub.turbo.net/images/docs/SAML-cert-install-2.PNG)
7. Select your certificate and click **Next** ![SAML-cert-install-3](https://hub.turbo.net/images/docs/SAML-cert-install-3.PNG)
8. Select **Place all certificates in the following store**, select **Trusted Root Certificate Authorities**, and then click **Next** ![SAML-cert-install-4](https://hub.turbo.net/images/docs/SAML-cert-install-4.PNG)
...
To generate this certificate and private key, please refer to the [Service Provider Signing Certificate](https://hub.turbo.net/docs/server/authentication/saml#prerequisites-service-provider-signing-certificate) documentation.

Once generated, Turbo Server must be configured with the respective **Request Signing**, **Request Signing Private Key**, and **Request Signature Algorithm** settings. The certificate must also be uploaded to Azure AD under the **SAML Certificates > Verification certificates** section. See [SAML Certificates](https://hub.turbo.net/docs/server/authentication/azuread-saml#configure-azure-ad-saml-certificates) for more information.

### Azure AD Multi-Tenancy

Multi-tenancy allows users from different Azure AD tenants to login to Turbo Server using the same SSO configuration. It is recommended to switch to [Azure OpenID](https://hub.turbo.net/docs/server/authentication/azuread-openid-connect) to enable multitenant authentication.
...
![Assignment blocks user login](https://hub.turbo.net/images/docs/blocked_user.png)
...
![Azure AD Enterprise Application Assignment Required](https://hub.turbo.net/images/docs/assignment_required.png)
...
![Add users and groups to Azure AD Application Assignment](https://hub.turbo.net/images/docs/assign_users_and_groups.png)
