...
1. Go to the [administration reports](https://hub.turbo.net/docs/server/administration/reports#administration-reports).
...
4. If the logs do not provide any useful information, try launching the application locally using the Turbo CLI with the [diagnostics flag](https://hub.turbo.net/docs/reference/command-line/run).
...
To resolve the issue, configure the server according to the [Network Security](https://hub.turbo.net/docs/server/security/security#network) documentation.
...
The WebSocket connection may also be blocked by your [load balancer or proxy](https://hub.turbo.net/docs/server/network-and-load-balancing/network-and-load-balancing#troubleshooting). To test the WebSocket connection required for the connection, open a browser console and run the following JavaScript:
...
You may manage your repositories from the administration site [Hub page](https://hub.turbo.net/docs/server/administration/hub).
...
No application servers are currently available. Occurs when there are no application servers running, or when the Broker service cannot access the application servers. Please refer to the [Application Server troubleshooting](https://hub.turbo.net/docs/server/troubleshooting/application-server#application-server-is-unavailable) documentation to diagnose.
...
1. Check the connectivity between the Broker service and the Application Server. The Application Server might be slow or unresponsive, or there could be a network issue between the two services. Please refer to the [Application Server troubleshooting](https://hub.turbo.net/docs/server/troubleshooting/application-server#application-server-is-unavailable) for more information.
...
Occurs when the application or broker server is unavailable. Please refer to the [Application Server troubleshooting](https://hub.turbo.net/docs/server/troubleshooting/application-server#application-server-is-unavailable) documentation to diagnose.
...
2. Open **Server Manager** and click on **Tools** > **Computer Management**.
   ![Computer Management](https://hub.turbo.net/images/docs/computer-management.png)
...
5. Click on the **Member Of** tab and check that the **Remote Desktop Users** group is listed.
   ![User Properties Merber Of](https://hub.turbo.net/images/docs/user-properties-merberof.png)
...
To configure this timeout, see [Streaming](https://hub.turbo.net/docs/server/administration/general#streaming) for more information.
...
5. Uncheck the **User must change password at next logon** setting.
   ![User Properties](https://hub.turbo.net/images/docs/user-properties.png)
...
![Account Lockout Policy](https://hub.turbo.net/images/docs/account-lockout-policy.png)
...
![Password Policy](https://hub.turbo.net/images/docs/password-policy.png)
...
![Service Failed To Start](https://hub.turbo.net/images/docs/71d744ec-b482-416b-b29e-91b39b6407fb.png)
