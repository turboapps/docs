...
The following section details the **Import Configuration** feature available in Turbo Studio. Import Configuration is used to import application packages in various formats into a Turbo Studio configuration that can be built and [deployed](/deploying/overview/overview) to your endpoints.
...
For more information on deploying applications with Turbo, see [Deploying to a Desktop](/deploying/to-a-desktop/to-a-desktop).
