...
<table>
   ...
   <tr>
      ...
      <td>
         ...
         <p>Attributes:
             <ul>
                <li><strong>name</strong> - The name of the package. In this context it will always be *Java*.</li>
      ...
      <td>
         ...
         <p>Root directory elements include:
             <ul>
                ...
                <li><strong>@PROGRAMFILESX86@* -Resolves to the 32-bit program files directory (ex: <strong>c:\program files (x86)</strong> on 64-bit operating system, <strong>c:\program files</strong> on 32-bit operating system).</li>
                <li><strong>@PROGRAMFILESCOMMONX86@* -Resolves to the 32-bit common program files directory (ex: <strong>c:\program files (x86)\common files</strong> on 64-bit operating system, <strong>c:\program files\common files</strong> on 32-bit operating system).</li>
