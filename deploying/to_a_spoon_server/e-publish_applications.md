...
To be hosted on Spoon Server applications must be converted into Turbo Virtual Applications (**SVM** files) using the Spoon Studio. The Spoon Studio monitors the installation of your application, analyzes the installation, and constructs a virtual package which you can upload to Spoon Server. Experienced users can convert most applications for Turbo in minutes.
...
Refer to the Spoon Studio help documentation for detailed instructions on how to create a Turbo application.
