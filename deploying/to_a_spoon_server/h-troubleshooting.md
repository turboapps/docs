...
2. Via the **Command Prompt** using the **net** command
	...
	b. Type the command net stop turbo to stop the Spoon Server service
	...
	c. Type the command net start turbo to start the Spoon Server service
